...
4. 按蓝图落 CH 管理面可见性：source list、fresh/stale、index status、memory candidates、confirmed memories、recall test、used context trace、forget/audit。
5. 为 source、ingestion、retrieval、memory、cleanup 和 diagnostics 建合同测试。
